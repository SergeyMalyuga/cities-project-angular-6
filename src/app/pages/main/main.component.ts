...
import {selectCurrentCity, selectIsOffersLoading, selectOffersByCity,} from '../../store/app/selectors/app.selectors';
...
@Component({
  selector: 'app-main',
  imports: [HeaderComponent, OfferCardComponent, NgClass, MapComponent, PlacesSortingFormComponent, SortByPipe, LoaderComponent],
